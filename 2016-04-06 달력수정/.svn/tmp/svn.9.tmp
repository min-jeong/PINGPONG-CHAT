...
html {
	scrollbar-3dLight-Color: #71d1b2;
	scrollbar-arrow-color: #dfdfdf;
	scrollbar-base-color: #71d1b2;
	scrollbar-Face-Color: #dfdfdf;
	scrollbar-Track-Color: #71d1b2;
	scrollbar-DarkShadow-Color: #71d1b2;
	scrollbar-Highlight-Color: #71d1b2;
	scrollbar-Shadow-Color: #71d1b2;
}
#myProgress {
    position: relative;
    width: 100%;
...
<body id="content">
								...
								<div class="content-panel" style="overflow: auto;">
									<h4>
										<i class="fa fa-angle-right"></i> 날짜별 대화 참여
										 <button type="button" class="md md-help" data-trigger="hover" data-toggle="popover" data-placement="bottom" data-content="가입된 Team List"  style="border-radius :50%; background-color: #ffffff; border: 0; size: 50%;"></button>
									</h4>
	...
	<script>
		...
		var morrisLine = Morris.Line({
			...
			ykeys : nickdate(),
			labels : nickdate(),
			lineColors : [ '#4ECDC4', '#FF85CA' ,'#cd2225','#fd5111','#2478FF', '#B95AFF']
		});
