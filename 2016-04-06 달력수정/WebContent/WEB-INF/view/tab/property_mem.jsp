...
<link href="/resource/css/moris/style-responsive.css"
   rel="stylesheet">
            ...
            <ul class="header-inner">
              ...
              <li class="pull-right"  style="color: black;">
                <ul class="top-menu">
                    ...
                    <li class="hidden-xs" id="chat-trigger" data-trigger="#chat" style="color: #323e4a; background-color: #71d1b2; border-radius : 5px 5px 5px 5px">
                  ...
                  <c:forEach items="${totalRate}" var="list" varStatus="status">
                     <div class="col-sm-3">
                        <div class="epc-item bgm-transparent">
                           <div class="easy-pie main-pie" data-percent="45" style="background-color: black;">
                              ...
                              <div class="lv-body">
                                 <div class="p-15">
                                    <div class="lv-item">
                                       <div class="media">
                                          <div class="pull-left">
                                             1 <i class="md md-brightness-5"></i>
                                          </div>
                                    ...
                                    <div class="lv-item">
                                       <div class="media">
                                          <div class="pull-left">
                                             2 <i class="md md-brightness-3"></i>
                                          </div>
                                    ...
                                    <div class="lv-item">
                                       <div class="media">
                                          <div class="pull-left">
                                             3 <i class="md md-quick-contacts-mail"></i>
                                          </div>
                                    ...
                                    <div class="lv-item">
                                       <div class="media">
                                          <div class="pull-left">
                                             5 <i class="md md-mood" title="이건?"></i>
                                          </div>
                                    ...
                                    <div class="lv-item">
                                       <div class="media">
                                          <div class="pull-left">
                                             6 <i class="md md-whatshot" title="이건?"></i>
                                          </div>
      ...
      var Script = function() {
         ...
         $(function() {
            ...
            Morris.Donut({
               element : 'hero-donut',
               data : donutData,
               colors : ['#2a99b7', '#3bbdc0', '#804a82', '#7c95be', '#f5bc4b', '#8ac050', '#70c9a6', '#48d1ff', '#4974c5'],
