					...
					<div class="pmb-block">
                       <div class="p-header">
                           <ul class="p-menu">
                               ...
                               <button class="btn bgm-amber btn-icon" style=" color: white; float: right;  box-shadow: 0 2px 7px rgba(0, 0, 0, 0);" id="deleteTeam"><i class="md md-close"></i></button>
						...
						<div class="contacts clearfix row">
							<c:forEach items="${ memberList }" var="memEmail">
		                                ...
		                                <div class="c-item" style="">
		                                    <div class="ci-avatar">
		                                    	<c:if test="${ memEmail.pic_name eq null }">
		                                    		<img src="resource/img/notifications.png"  height="130px">
		                                    	</c:if>
		                                    	<c:if test="${ memEmail.pic_name ne null }">
		                                       		<img src="/callMemberImage?picName=${ memEmail.pic_name }"  alt="" height="130px">
		                                    	</c:if>
		                                    </div>
		                                    <div class="c-info">
	                            ...
	                            <div class="col-md-3 col-sm-6 col-xs-6" >
	                                <div class="c-item" style="border: 0;">
	                                    <div class="ci-avatar">
                                    		<a href="#addMem"  data-toggle="modal"  id="add"><img src="resource/img/add.png" class="img-responsive" style="height: 100px; width: 100px; margin-top: 50px;"></a>
	                                    </div>
	                                </div>
	                            </div>
						</div>
